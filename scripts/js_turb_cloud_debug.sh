...
#SBATCH -J 0613_conv_cloud
#SBATCH -o ./out/240613/conv_cloud."%j".out
#SBATCH -e ./out/240613/conv_cloud."%j".err
...
cd $DP/rescaling_conv/cloud

srun ../../athena_turb_verbose -i athinput_cloud.turb -t 00:09:30
