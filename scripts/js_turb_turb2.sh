...
#SBATCH -J 0612_0.5_100_turb
#SBATCH -o ./out/240612/0.5_100_turb."%j".out
#SBATCH -e ./out/240612/0.5_100_turb."%j".err
...
mkdir -p /freya/ptmp/mpa/wuze/out/240612
cd $DP/240612_0.5_100/turb
