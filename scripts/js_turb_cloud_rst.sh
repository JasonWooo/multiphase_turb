...
#SBATCH -J jason_240611_cloud
#SBATCH -o ./out/240611/jason_240611_cloud."%j".out
#SBATCH -e ./out/240611/jason_240611_cloud."%j".err
...
mkdir -p /freya/ptmp/mpa/wuze/out/240611
cd $DP/240610_0.6_2032/cloud

srun ../../athena_turb -i athinput_cloud.turb -r ../turb/Turb.final.rst -t 02:55:00
